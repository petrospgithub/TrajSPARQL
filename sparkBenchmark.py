...
--conf spark.yarn.archive=hdfs:///user/root/spark230_jars/spark230.tar.gz --class benchmark.createResources target/TrajSPARQL-jar-with-dependencies.jar octree_repartition_imis400_parquet octree_traj_partitionMBBDF_binary_imis400_parquet")
