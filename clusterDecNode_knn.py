...
os.system("mvn test -Dtest=knnQueries_arrPID -q >> "+str(15-int(sys.argv[1]))+"_worker")

time.sleep(60)

#os.system("mvn test -Dtest=knnQueries_arrIndex -q >> "+str(15-int(sys.argv[1]))+"_worker")
...
os.system("mvn test -Dtest=knnQueries_traj -q >> "+str(15-int(sys.argv[1]))+"_worker")
